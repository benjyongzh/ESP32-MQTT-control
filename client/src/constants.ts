...
export const DEFAULT_TEMPERATURE_SENSOR_READ_INTERVAL_SECONDS = 5;
export const MIN_TEMPERATURE_SENSOR_READ_INTERVAL_SECONDS = 1;
export const MAX_TEMPERATURE_SENSOR_READ_INTERVAL_SECONDS = 30;
